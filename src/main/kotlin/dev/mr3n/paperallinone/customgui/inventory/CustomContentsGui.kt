 ...
 */
open class CustomContentsGui(plugin: JavaPlugin, size: Int, title: Component, private val startX: Int, private val startY: Int, private val endX: Int, private val endY: Int, private val runnable: CustomContentsGui.() -> Unit = {}): CustomGui(plugin, title, size) {
    ...
    open fun add(itemStack: ItemStack, update: Boolean = false, runnable: ActionItem.() -> Unit = {}): CustomContentsGui {
    ...
    open fun add(actionItem: ActionItem, update: Boolean = false, runnable: ActionItem.() -> Unit = {}): CustomContentsGui {
    ...
    companion object {
        ...
        fun JavaPlugin.createCustomContentsGui(size: Int, title: Component, startX: Int, startY: Int, endX: Int, endY: Int, runnable: CustomContentsGui.() -> Unit = {}): CustomContentsGui {
